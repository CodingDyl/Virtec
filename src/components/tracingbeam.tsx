...
export const TracingBeam = ({
  ...
  return (
    <motion.div
      ref={ref}
      className={cn("relative w-full max-w-4xl mx-auto h-full z-0 !important", className)}
    >
      <div className="absolute z-0 -left-20 top-3">
        <motion.div
          transition={{
            duration: 0.2,
            delay: 0.5,
        ...
        <svg
          ...
          className=" ml-4 hidden lg:block z-0"
          aria-hidden="true"
        >
          <motion.path
