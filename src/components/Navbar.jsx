...
const Navbar = () => {
  ...
  return (
    <nav className={`${styles.paddingX} w-full flex items-center py-5 absolute top-0 z-10 bg-black/20 md:bg-transparent`}>
      <div className="h-10 md:h-20 w-full flex justify-between items-center max-w-7xl mx-auto">
        <Link to="/" className="flex items-center gap-2" onClick={() => { setActive(""); window.scrollTo(0, 0); }}>
          <img src={mainLogo} alt="logo" className="h-4 md:h-7 w-full object-cover border-0" />
        </Link>
