  ...
  return (
    <div className="flex flex-col items-center justify-center h-auto relative z-20  ">
      ...
      <div className="flex flex-col md:flex-row space-y-4 md:space-y-0 space-x-0 md:space-x-4">
        <a href="#about">
        <Button  borderRadius="1.75rem"  className="bg-slate-800 text-white hover:bg-black border-slate-800">
          Learn More
        </Button>
        </a>
        <a href="#contact">
        <Button borderRadius="1.75rem"
        className="bg-slate-800 text-white hover:bg-black border-slate-800" >
          Yes, I want that!
        </Button>
        </a>
